        ...
        return (
            <div className="container">
                <div className="presentation">
                    <h1 className="h1Accueil">On the flux</h1>
                    <h2 className="h2Accueil">Ce site référencie tous les films d'horreur les plus flippants du quiz</h2>
                    <p className="text">Nous sommes une équipe de quatre dev qui te proposent de découvrir notre sélection raffinée. </p>
                    <h3 className="h3">En voici une brève sélection ma p'tite flipette</h3>
                </div>
                <div className="film">
